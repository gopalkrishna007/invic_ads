...
<div class="page-content">
    ...
    <div class="content">
        <ul class="breadcrumb">
            ...
            <li><a href="<?= base_url("admin/addsubjects") ?>" class="active">addsubjects</a> </li>
        </ul>
        <div class="page-title"> <i class="icon-custom-left"></i>
            <h3>Add <span class="semi-bold">Subjects</span> </h3>
        </div>
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="grid simple">
                    ...
                    <div class="grid-body no-border"> <br>
                        <div class="row">
							...
							<form action="<?= base_url("admin/savesubjects") ?>" class="login-form validate" id="login-form" method="post" name="login-form">
                                <div class="form-group">
                                    <div class="col-md-3"><label class="form-label"> Subject Name</label></div>
                                    <div class="col-md-4"><input type="text" name="subjectsname" class="form-control" required value="<?= @$subjectsData['subject_name'] ?>" ></div>
                                    <div class="clearfix"></div>
                                </div>
                               
                                <input type="hidden" name="id" class="form-control"  value="<?= @$subjectsData['id'] ?>" >
