...
<h3>Create <span class="semi-bold">New</span> Trainings </h3>
</div>
...
<div class="col-md-3">
<label class="form-label">Sample Video (Upload)</label>
</div>
<div class="col-md-4">
<label class="btn btn-default btn-file">
...
<div class="col-md-3">
<label class="form-label">Trainer Profile ID</label>
</div>
<div class="col-md-4">
<input type="text" class="form-control">
</div>
...
<option value="AK">Training 1</option>
<option value="HI">Training 2</option>
</optgroup>
...
<div class="col-md-3">
<label class="form-label">Price M.R.P.</label>
</div>
<div class="col-md-4">
<div class="input-group">
<span class="input-group-addon primary">
<span class="arrow"></span>
<i style="padding:5px 3px;" class="fa fa-inr" aria-hidden="true"></i>
</span>
