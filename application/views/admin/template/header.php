    ...
    <div class="header navbar navbar-inverse ">
        <div class="navbar-inner">
            <div class="header-seperation">
                ...
                </ul><a href="<?= base_url('admin/dashboard') ?>"><img src="<?= base_url().'assets/admin/' ?>img/logo11.png" class="logo" alt data-src="<?= base_url().'assets/admin/' ?>img/logo11.png" data-src-retina="<?= base_url().'assets/admin/' ?>img/logo11.png" width="106" height="21"/></a>
            ...
            <div class="header-quick-nav">
                ...
                <div class="pull-right">
                    <div class="chat-toggler sm">
                        <div class="profile-pic"><img src="<?= base_url() ?>assets/admin/img/logo11.png" alt data-src="http://localhost/ads/assets/admin/img/logo11.png" data-src-retina="<?= base_url() ?>assets/admin/img/logo11.png" width="35" height="35" />
        ...
        <div class="page-sidebar " id="main-menu">
            <div class="page-sidebar-wrapper scrollbar-dynamic" id="main-menu-wrapper">
                <div class="user-info-wrapper sm">
                    <div class="profile-wrapper sm"><img src="http://localhost/ads/assets/admin/img/logo11.png" alt data-src="http://localhost/ads/assets/admin/img/logo11.png" data-src-retina="http://localhost/ads/assets/admin/img/logo11.png" width="69" height="69" />
                        <div class="availability-bubble online"></div>
                    </div>
                ...
                <ul>                    
                    <li> <a href="javascript:void(0);"> <i class="material-icons">Users</i> <span class="title">Admin Users</span> <span class=" arrow"></span> </a>
                        <ul class="sub-menu">
                            <li> <a href="<?= base_url("admin/createAdminUser") ?>">Add Admin Users</a> </li>
                             <li> <a href="<?= base_url("admin/viewAdminUser") ?>">View Admin Users</a> </li>
                        </ul>
                    </li>
                    <li> <a href="javascript:;"> <i class="material-icons">invert_colors</i> <span class="title">Administration</span> <span class=" arrow"></span> </a>
                        <ul class="sub-menu">
                            <li> <a href="<?= base_url("admin/serverrefreshtime") ?>">Configuration Properties</a> </li>
                        </ul>
                    </li>                    
					...
					<li> <a href="javascript:;"> <i class="material-icons">Devices</i> <span class="title">Devices Info</span> <span class=" arrow"></span> </a>
                        <ul class="sub-menu">
                            <li> <a href="<?= base_url("admin/adddevice") ?>">Add Devices</a> </li>
                             <li> <a href="<?= base_url("admin/viewDevices") ?>">View Devices</a> </li>
                        </ul>
                    </li>
                    <li> <a href="javascript:;"> <i class="material-icons">Franchise</i> <span class="title">Franchise Info</span> <span class=" arrow"></span> </a>
                        <ul class="sub-menu">
                            <li> <a href="<?= base_url("admin/franchise") ?>">Add Franchise</a> </li>
                             <li> <a href="<?= base_url("admin/viewfranchises") ?>">View Franchises</a> </li>
                        </ul>
                    </li>
                    <li> <a href="javascript:;"> <i class="material-icons">Services</i> <span class="title">Services Info</span> <span class=" arrow"></span> </a>
                        <ul class="sub-menu">
                            <li> <a href="<?= base_url("admin/service") ?>">Add service</a> </li>
                             <li> <a href="<?= base_url("admin/viewservices") ?>">View services</a> </li>
                        </ul>
                    </li>
					<li> <a href="javascript:;"> <i class="material-icons">Roles</i> <span class="title">Roles</span> <span class=" arrow"></span> </a>
                        <ul class="sub-menu">
                            <li> <a href="<?= base_url("admin/addroles") ?>">Add Role</a> </li>
							 <li> <a href="<?= base_url("admin/listroles") ?>">View Roles</a> </li>
                        </ul>
                    </li>
                    <li> <a href="javascript:void(0);"> <i class="material-icons">Users</i> <span class="title">Users</span> <span class=" arrow"></span> </a>
                        <ul class="sub-menu">
