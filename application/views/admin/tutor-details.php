...
<h3>Edit <span class="semi-bold">Tutor</span> </h3>
</div>
...
<option value="HI">VIzag</option>
<option value="HI">Vijayawada</option>
</optgroup>
...
<div class="col-md-3">
<label class="form-label">Select Preferred Location</label>
</div>
<div class="col-md-4">
...
<div class="col-md-3">
<label class="form-label">Select tution Type</label>
</div>
<div class="col-md-4">
<select id="source" style="width:100%">
<optgroup>
<option value="AK">Type 1</option>
<option value="HI">Type 2</option>
<option value="HI">Type 3</option>
</optgroup>
...
<div class="col-md-3">
<label class="form-label">Select subjects To teach</label>
</div>
<div class="col-md-4">
<select id="source" style="width:100%">
<optgroup>
<option value="AK">Maths</option>
<option value="HI">Social</option>
...
<div class="col-md-3">
<label class="form-label">Select Education Board</label>
</div>
<div class="col-md-4">
<select id="source" style="width:100%">
<optgroup>
<option value="AK">Board 1</option>
<option value="HI">Board 2</option>
<option value="HI">Board 3</option>
</optgroup>
