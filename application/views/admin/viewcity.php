...
<div class="page-content">
   <div class="content">
      ...
      <div class="page-title">
         ...
         <h3>View <span class="semi-bold">City</span></h3>
      </div>
      <div class="row">
         <div class="col-md-12">
                  ...
                  <table class="table no-more-tables">
                     ...
                     <tbody>
                        ...
                        <tr id="remove<?= $dat['id'] ?>">
						   ...
						   <span class="label <?= ($dat['city_status'] == 1)?'label-important':(($dat['city_status'] == 1)?'label-success':'') ?>"><?= ($dat['city_status'] == 1)?'Active':(($dat['city_status'] == 2)?'In Active':'') ?></span>
						   </td>
                           <td class="v-align-middle">
                              <div class="btn-group">
                                 ...
                                 <ul class="dropdown-menu">
                                    <li data-filter="camping" data-dimension="recreation"><a href="<?= base_url("admin/addcity/".$dat['id']) ?>">Edit</a></li>
                                    ...
                                    <li data-filter="fishing" data-dimension="recreation" style="cursor: pointer;"><a class="sweet-2" data="<?= $dat['id'] ?>" data-status="<?= ($dat['city_status'] == 1)?'2':'1' ?>" onclick="_gaq.push(['_trackEvent', 'example', 'try', 'sweet-2']);"><?= ($dat['city_status'] == 1)?'Deactivate':'Activate' ?></a></li>
                                 </ul>
                              </div>
                           </td>
                        </tr>
        ...
        button.onclick = function() {
            ...
            swal({
                ...
                if (isConfirm) {
                    $.ajax({
                        type: "POST",
                        url: '<?= base_url("admin/updatecitystatus") ?>',
                        data: {
                            "id": id,
                            "status": status
                        },
