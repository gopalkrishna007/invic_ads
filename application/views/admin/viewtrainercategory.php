...
<div class="page-content">
   <div class="content">
      ...
      <div class="page-title">
         ...
         <h3>View <span class="semi-bold">Trainer Categories</span></h3>
      </div>
      <div class="row">
         <div class="col-md-12">
                           ...
                           <td class="v-align-middle">
                              <div class="btn-group">
                                 ...
                                 <ul class="dropdown-menu">
                                    <li data-filter="camping" data-dimension="recreation"><a href="<?= base_url("admin/trainercategory/".$dat['id']) ?>">Edit</a></li>
        ...
        button.onclick = function() {
            ...
            swal({
                ...
                if (isConfirm) {
                    $.ajax({
                        type: "POST",
                        url: '<?= base_url("admin/deletetrainercategory") ?>',
                        data: {
                            "id": id
                        },
                        dataType: "json",
        ...
        button.onclick = function() {
            ...
            swal({
                ...
                if (isConfirm) {
                    $.ajax({
                        type: "POST",
                        url: '<?= base_url("admin/updatetrainercategory") ?>',
                        data: {
                            "id": id,
                            "status": status
                        },
