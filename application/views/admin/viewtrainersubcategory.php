...
<div class="page-content">
   <div class="content">
      ...
      <div class="page-title">
         ...
         <h3>View <span class="semi-bold">Trainer Sub Categories</span></h3>
      </div>
      <div class="row">
         <div class="col-md-12">
                  ...
                  <table class="table no-more-tables">
                     ...
                     <tbody>
                        ...
                        <tr id="remove<?= $dat['id'] ?>">
                           ...
                           <td><span class="muted"><?= ucwords($dat['trainer_sub_category_name']) ?></span></td>
                           <td><span class="muted"><?= ucwords($dat['trainer_category_name']) ?></span></td>
                           ...
                           <td class="v-align-middle">
                              <div class="btn-group">
                                 ...
                                 <ul class="dropdown-menu">
                                    <li data-filter="camping" data-dimension="recreation"><a href="<?= base_url("admin/addtrainersubcategory/".$dat['id']) ?>">Edit</a></li>
        ...
        button.onclick = function() {
            ...
            swal({
                ...
                if (isConfirm) {
                    $.ajax({
                        type: "POST",
                        url: '<?= base_url("admin/deletetrainersubcategory") ?>',
                        data: {
                            "id": id
                        },
                        dataType: "json",
                        success: function(data) {
                            if (data.success == 1) {
                                $("remove"+id).remove();
                                swal("Deleted!", "Trainer sub Category has been deleted!", "success");
								window.location='';
                            } else {
        ...
        button.onclick = function() {
            ...
            swal({
                ...
                if (isConfirm) {
                    $.ajax({
                        type: "POST",
                        url: '<?= base_url("admin/updatetrainersubcategory") ?>',
                        data: {
                            "id": id,
                            "status": status
                        },
