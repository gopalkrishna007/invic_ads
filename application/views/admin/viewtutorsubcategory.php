...
<div class="page-content">
   <div class="content">
      ...
      <div class="page-title">
         ...
         <h3>View <span class="semi-bold">Tutor Category</span></h3>
      </div>
      <div class="row">
         <div class="col-md-12">
                  ...
                  <table class="table no-more-tables">
                     ...
                     <tbody>
                        ...
                        <tr id="remove<?= $dat['id'] ?>">
                           ...
                           <td><span class="muted"><?= ucwords($dat['tutor_sub_category']) ?></span></td>
                           <td><span class="muted"><?= ucwords($dat['category']) ?></span></td>

						   <td><span class="muted"><?php if($dat['tutor_sub_category_image'] != ''){ ?> <img style="width: 25%;" src="<?= base_url()."uploads/tutor_sub_category/".$dat['tutor_sub_category_image'] ?>" /> <?php } ?></span></td>
                           ...
                           <td class="v-align-middle">
                              <div class="btn-group">
                                 ...
                                 <ul class="dropdown-menu">
                                    <li data-filter="camping" data-dimension="recreation"><a href="<?= base_url("admin/addtutorsubcategory/".$dat['id']) ?>">Edit</a></li>
        ...
        button.onclick = function() {
            ...
            swal({
                ...
                if (isConfirm) {
                    $.ajax({
                        type: "POST",
                        url: '<?= base_url("admin/deletetutorsubcategory") ?>',
                        data: {
                            "id": id
                        },
                        dataType: "json",
                        success: function(data) {
                            if (data.success == 1) {
                                $("remove"+id).remove();
                                swal("Deleted!", "Tutor Category has been deleted!", "success");
								window.location='';
                            } else {
        ...
        button.onclick = function() {
            ...
            swal({
                ...
                if (isConfirm) {
                    $.ajax({
                        type: "POST",
                        url: '<?= base_url("admin/updatetutorsubcategory") ?>',
                        data: {
                            "id": id,
                            "status": status
                        },
